...
- Using SQL instead of pandas filtering for `--stats` flag in `filter` command  -> Too complex in query handle and building, harder to maintain, also, often slower compare to old pandas filtering method
